                ...
                <div className="relative bg-gradient-to-br from-red-900/40 via-red-800/30 to-red-900/40 backdrop-blur-xs rounded-3xl border-2 border-yellow-600/40 p-12 shadow-2xl">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex gap-6 bg-red-900/30 rounded-xl p-6 border border-yellow-600/20">
                      ...
                      <div className="flex-1 space-y-3">
                        ...
                        <div className="flex items-center gap-4 pt-2">
                          <button className="bg-gradient-to-r from-yellow-600 to-yellow-500 text-white px-6 py-2 rounded-full text-sm font-medium hover:from-yellow-500 hover:to-yellow-400 transition-all">
                            Mua Luận Giải
                          </button>
                    ...
                    <div className="flex items-center justify-center gap-4 pt-6 border-t border-yellow-600/20">
                      <button className="bg-gradient-to-r from-yellow-600 to-yellow-500 text-white px-8 py-3 rounded-full font-semibold hover:from-yellow-500 hover:to-yellow-400 transition-all shadow-lg">
                        Mua Luận Giải
                      </button>
